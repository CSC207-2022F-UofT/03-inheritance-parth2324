...
public class BagMainTest {
    ...
    public void TestEnhanceBagsTrue() {
        ...
        assertEquals(7, bags[1].getCapacity());  // added 2 since crossbody bag enhance is by 2 !
        assertEquals(6, bags[2].getCapacity());
        assertEquals(9, bags[3].getCapacity());  // added 2 since crossbody bag enhance is by 2 !
    }
    @Test(timeout = 50)
